...
if 'cloudinary' not in settings.DEFAULT_FILE_STORAGE.lower():
    ...
    print("      - CLOUDINARY_CLOUD_NAME = configurado en las variables de entorno")
    print("      - CLOUDINARY_API_KEY = configurado en las variables de entorno")
    print("      - CLOUDINARY_API_SECRET = configurado en las variables de entorno")
